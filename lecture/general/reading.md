...
Each group is required to present one ~30 minute presentation on a paper that is relevant to their topic.
...
| 15/12/2025 | E | Statistical and methodological problems with concreteness and other semantic variables: A list memory experiment case study. | Pollock | 2018 | [*Behavior Research Methods*, *50*(3), 1198-1216.](https://doi.org/10.3758/s13428-017-0938-y) |
...
* Eisape, T., Zaslavsky, N., & Levy, R. (2020). Cloze distillation: Improving neural language models with human next-word prediction. *Association for Computational Linguistics (ACL)*. https://doi.org/10.18653/v1/2020.conll-1.49
...
* Lopes Rego, A. T., Snell, J., & Meeter, M. (2024). Language models outperform cloze predictability in a cognitive model of reading. *PLOS Computational Biology*, *20*(9), e1012117. https://doi.org/10.1371/journal.pcbi.1012117

### Group B: Synaesthetic Stroop Task
...
* Hohlfeld, A. (2006). Accessing grammatical gender in German: The impact of gender-marking regularities. *Applied Psycholinguistics*, *27*(2), 127–142. https://doi.org/10.1017/S0142716406060218
